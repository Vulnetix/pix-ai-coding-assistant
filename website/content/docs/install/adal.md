...
title: "AdaL"
weight: 31
description: "Install the Vulnetix security plugin for AdaL."
---
...
This installs the Vulnetix security skills into your project's `.adal/skills` directory.
...
The plugin registers the following into `.adal/skills`:
