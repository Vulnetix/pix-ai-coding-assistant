...
title: "Aider"
weight: 30
description: "Install the Vulnetix security plugin for Aider."
---
...
This installs the Vulnetix security skills into your project's `.aider/skills` directory.
...
The plugin registers the following into `.aider/skills`:
