...
Augment supports hooks natively. The plugin ships `hooks.augment.json` pre-configured for Augment's hook system. After install, hooks are registered automatically — no manual configuration needed.
