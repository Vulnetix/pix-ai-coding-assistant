...
title: "CodeBuddy"
weight: 5
description: "Install the Vulnetix security plugin for CodeBuddy."
---
...
This installs the Vulnetix security skills into your project's `.codebuddy/skills` directory.
...
The plugin registers the following into `.codebuddy/skills`:
...
CodeBuddy supports hooks natively. The plugin ships `hooks.codebuddy.json` pre-configured for CodeBuddy's hook system. After install, hooks are registered automatically — no manual configuration needed.
