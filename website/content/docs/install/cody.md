...
weight: 32
description: "Install the Vulnetix security plugin for Sourcegraph Cody."
---
...
This installs the Vulnetix security skills into your project's `.cody/skills` directory.
...
The plugin registers the following into `.cody/skills`:
