...
title: "Command Code"
weight: 6
description: "Install the Vulnetix security plugin for Command Code."
---
...
This installs the Vulnetix security skills into your project's `.commandcode/skills` directory.
...
The plugin registers the following into `.commandcode/skills`:
