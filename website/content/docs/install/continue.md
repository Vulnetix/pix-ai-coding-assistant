...
title: "Continue"
weight: 7
description: "Install the Vulnetix security plugin for Continue."
---
...
This installs the Vulnetix security skills into your project's `.continue/skills` directory.
...
The plugin registers the following into `.continue/skills`:
