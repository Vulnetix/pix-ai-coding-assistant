...
title: "Cortex Code"
weight: 8
description: "Install the Vulnetix security plugin for Cortex Code."
---
...
This installs the Vulnetix security skills into your project's `.cortex/skills` directory.
...
The plugin registers the following into `.cortex/skills`:
...
Cortex Code supports hooks natively. The plugin ships `hooks.cortex.json` pre-configured for Cortex Code's hook system. After install, hooks are registered automatically — no manual configuration needed.
