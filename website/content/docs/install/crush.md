...
title: "Crush"
weight: 9
description: "Install the Vulnetix security plugin for Crush."
---
...
This installs the Vulnetix security skills into your project's `.crush/skills` directory.
...
The plugin registers the following into `.crush/skills`:
