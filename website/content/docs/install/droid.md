...
title: "Droid"
weight: 10
description: "Install the Vulnetix security plugin for Droid."
---
...
This installs the Vulnetix security skills into your project's `.factory/skills` directory.
...
The plugin registers the following into `.factory/skills`:
