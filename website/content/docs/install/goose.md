...
title: "Goose"
weight: 11
description: "Install the Vulnetix security plugin for Goose."
---
...
This installs the Vulnetix security skills into your project's `.goose/skills` directory.
...
The plugin registers the following into `.goose/skills`:
