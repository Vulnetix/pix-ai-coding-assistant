...
title: "IBM Bob"
weight: 3
description: "Install the Vulnetix security plugin for IBM Bob."
---
...
This installs the Vulnetix security skills into your project's `.bob/skills` directory.
...
The plugin registers the following into `.bob/skills`:
