...
title: "iFlow CLI"
weight: 13
description: "Install the Vulnetix security plugin for iFlow CLI."
---
...
This installs the Vulnetix security skills into your project's `.iflow/skills` directory.
...
The plugin registers the following into `.iflow/skills`:
...
iFlow CLI supports hooks natively. The plugin ships `hooks.iflow.json` pre-configured for iFlow's hook system. After install, hooks are registered automatically — no manual configuration needed.
