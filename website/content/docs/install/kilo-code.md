...
title: "Kilo Code"
weight: 14
description: "Install the Vulnetix security plugin for Kilo Code."
---
...
This installs the Vulnetix security skills into your project's `.kilocode/skills` directory.
...
The plugin registers the following into `.kilocode/skills`:
