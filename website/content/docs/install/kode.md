...
title: "Kode"
weight: 16
description: "Install the Vulnetix security plugin for Kode."
---
...
This installs the Vulnetix security skills into your project's `.kode/skills` directory.
...
The plugin registers the following into `.kode/skills`:
