...
title: "MCPJam"
weight: 17
description: "Install the Vulnetix security plugin for MCPJam."
---
...
This installs the Vulnetix security skills into your project's `.mcpjam/skills` directory.
...
The plugin registers the following into `.mcpjam/skills`:
