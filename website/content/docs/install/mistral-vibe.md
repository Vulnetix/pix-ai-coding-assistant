...
title: "Mistral Vibe"
weight: 18
description: "Install the Vulnetix security plugin for Mistral Vibe."
---
...
This installs the Vulnetix security skills into your project's `.vibe/skills` directory.
...
The plugin registers the following into `.vibe/skills`:
