...
title: "Mux"
weight: 19
description: "Install the Vulnetix security plugin for Mux."
---
...
This installs the Vulnetix security skills into your project's `.mux/skills` directory.
...
The plugin registers the following into `.mux/skills`:
