...
title: "Pochi"
weight: 30
description: "Install the Vulnetix security plugin for Pochi."
---
...
This installs the Vulnetix security skills into your project's `.pochi/skills` directory.
...
The plugin registers the following into `.pochi/skills`:
