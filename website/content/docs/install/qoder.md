...
title: "Qoder"
weight: 22
description: "Install the Vulnetix security plugin for Qoder."
---
...
This installs the Vulnetix security skills into your project's `.qoder/skills` directory.
...
The plugin registers the following into `.qoder/skills`:
...
Qoder supports hooks natively. The plugin ships `hooks.qoder.json` pre-configured for Qoder's hook system. After install, hooks are registered automatically — no manual configuration needed.
