...
title: "Roo Code"
weight: 24
description: "Install the Vulnetix security plugin for Roo Code."
---
...
This installs the Vulnetix security skills into your project's `.roo/skills` directory.
...
The plugin registers the following into `.roo/skills`:
