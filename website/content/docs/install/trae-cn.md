...
title: "Trae CN"
weight: 26
description: "Install the Vulnetix security plugin for Trae CN."
---
...
This installs the Vulnetix security skills into your project's `.trae/skills` directory.

> **Note:** Trae CN shares the `.trae/skills` directory with Trae. Installing for one agent makes the plugin available to both.
...
The plugin registers the following into `.trae/skills`:
