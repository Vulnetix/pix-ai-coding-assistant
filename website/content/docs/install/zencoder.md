...
title: "Zencoder"
weight: 28
description: "Install the Vulnetix security plugin for Zencoder."
---
...
This installs the Vulnetix security skills into your project's `.zencoder/skills` directory.
...
The plugin registers the following into `.zencoder/skills`:
